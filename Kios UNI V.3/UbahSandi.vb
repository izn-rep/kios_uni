...
Public Class UbahSandi
    ...
    Private Sub btnButton49_Click(sender As Object, e As EventArgs) Handles btnButton49.Click
        If TextBox2.Text = "" Or TextBox2.TextLength < 0 Then
        ...
        Else
            If TextBox2.Text = TextBox3.Text Then
                If CmdSQL("UPDATE pengguna SET kata_sandi ='" & TextBox2.Text & "' WHERE nama_pengguna ='" & TextBox1.Text & "'") = False Then
                    MsgBox("Error, Silahkan Hubungi Administrator!")
                    TextBox2.Text = ""
                    TextBox3.Text = ""
                Else
                    MsgBox("Kata Sandi Anda Berhasil Diubah!")
                    Me.Close()
                    Home.Show()
                End If
            Else
                TextBox2.Text = ""
                TextBox3.Text = ""
                MsgBox("Kata Sandi Anda Tidak Cocok/Sama!")
            End If
        End If
    ...
    Private Sub UbahSandi_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        TextBox1.Text = Home.Label1.Text
    ...
    Private Sub TextBox2_Click(sender As Object, e As EventArgs) Handles TextBox2.Click, TextBox3.Click
        LastSelected = sender
    End Sub
